...
def setup_graphics():
    ...
    # 그래프 창
    enrg_display = graph(title='Angular momentum vs r', xtitle='r', ytitle='Am',
                         width=600, height=400, xmin=0.999 * r_peri, xmax=1.001 * r_ap,
                         ymin=0)
...
while True:
    ...
    L = m_e * ((earth.pos.x * earth.vel.y - earth.pos.y * earth.vel.x))  # 각운동량은 보존됩니다!
